 ...
 */
zollty.render = function (filename, content) {
    return renderFile(filename, content);
};
...
/**
 * 渲染模板(根据模板名)
 * @name    zollty.renderFile
 * @param   {String}    模板名
 * @param   {Object}    数据
 * @return  {String}    渲染好的字符串
 */
var renderFile = zollty.renderFile = function (filename, data) {
    var fn = zollty.get(filename) || showDebugInfo({
        filename: filename,
        name: 'Render Error',
